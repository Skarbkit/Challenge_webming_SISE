...
def main():
    ...
    model = facial_emotion_recognition.load_model()
    ...
    while True:
        ...
        #mettre au format attendu par le modèle
        input_frame = facial_emotion_recognition.preprocess_input(rgb_frame)

        # détecter les visages et les émotions
        emotions = model.predict(input_frame)
